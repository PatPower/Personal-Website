    ...
    return (
        <div className='projects-container' id='projects'>
            ...
            <div className="projects-container-cards">
                ...
                <Card title='Hacking Game' videoUrl='./videos/video-hackinggame-card.mp4' body='Created in Unity. Explore a strange operating system and browse the web in this strange world.' skills={['Unity', 'C#']} link='/' website='/hackinggame'/>
